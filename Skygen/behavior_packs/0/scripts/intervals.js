...
const activeEffects = player.getEffects()
  ...
  player.nameTag = `${color}${nick} §r§c ${health.toFixed(2)}\n§f${getPlatform(player)} | ${getDevice(player)}${teamTag}`
...
${dashLine}\n §3Online: §b${world.getAllPlayers().length}/11\n §3Discord: §bn75YfSxCJF\n §3Realm: §bJoin Discord\n${dashLine}\n §6created by vyse xyz`,
      { 
